...
export function PropertyView({ property }: PropertyViewProps) {
  ...
  function shareOnInstagram() {
    ...
    ctx.fillText(title, 48, y0);

    ctx.font = "bold 48px Arial, sans-serif";
    ctx.fillStyle = "#34d399";
    ctx.fillText(formatPrice(property.price), 48, y0 + 80);
    ...
    link.click();
    toast.success("Card baixado! Agora é só postar no Instagram.");
  }
        ...
        <div className="px-4 py-8 space-y-8">
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-3 flex-wrap">
              ...
              <button onClick={shareOnInstagram} className="flex flex-col items-center gap-1 group" title="Gerar card para Instagram">
